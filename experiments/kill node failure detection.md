...
Data replication has ensured the data in M1 and M2 was not lost (even though 7.8% of M2 puts errored in the degraded cluster, that data was still written to the healthy replicas)
